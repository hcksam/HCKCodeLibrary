...
public class ReadInExcel {
	...
	public final static int INDEX_READTYPE_NoNull = 1;
	private File file;
	...
	public ArrayList<ArrayList<String>> getSheetData(int page, int READTYPE) {
	...
	public void showDatas(int page, int READTYPE) {
		ArrayList<ArrayList<String>> datas = getSheetData(page, READTYPE);
	...
	public static void main(String[] args) {
		...
		rix.showDatas(0, ReadInExcel.INDEX_READTYPE_NoNull);
	}
}
